...
- create/update the file versions1/latest-pre-release without new-line and setup 0.9.0 version folder
```
echo 0.9.0 > version.txt
mkdir versions1/0.9.0v
echo -n 0.9.0 > versions1/0.9.0v/latest-pre-release
cp versions1/certs.sector versions1/certs.sector.sig versions1/0.9.0v
cp versions1/public*key*   versions1/0.9.0v
```
...
idf.py app
mv build/LCM4ESP32.bin versions1/0.9.0v/otamain.bin
```
...
idf.py fullclean >/dev/null 2>&1; rm -rf /mnt/main
idf.py all
cp build/LCM4ESP32.bin versions1/0.9.0v/otaboot.bin
cp build/partition_table/partition-table.bin versions1/0.9.0v
cp build/bootloader/bootloader.bin versions1/0.9.0v
```
...
- commit and sync this as version 0.9.0  
...
```
openssl sha384 versions1/0.9.0v/otamain.bin
xxd versions1/0.9.0v/otamain.bin.sig
```

- upload the file versions1/0.9.0v/latest-pre-release to the 'latest release' assets on github
